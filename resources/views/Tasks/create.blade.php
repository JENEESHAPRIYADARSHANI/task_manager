<x-app-layout>
    <div class="w-3/4 h-1/4 mx-auto py-12">
        <h1 class="text-2xl font-bold text-center text-black mb-6">Create Task</h1>
        ...
        <form action="{{ route('task.store') }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="title" id="title"
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm 
                              focus:ring-indigo-500 focus:border-indigo-500 bg-white text-black text-sm">
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="2"
                          class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm 
                                 focus:ring-indigo-500 focus:border-indigo-500 bg-white text-black text-sm"></textarea>
            </div>
